    ...
    <>
      <div className="navbar shadow-lg">
        ...
        <div className="right-nav">
          <h5>{name}</h5>
          <button
            className="addhabit-btn shadow-lg"
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button
                type="button"
                className="btn btn-secondary btn-habit shadow-lg"
                data-bs-dismiss="modal"
              >
                Cancel
              </button>
              <button type="button" className="btn btn-primary btn-habit shadow-lg" onClick={handleSave}>
                Save
              </button>
            </div>
          </div>
